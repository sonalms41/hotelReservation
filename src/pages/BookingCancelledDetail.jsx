...
import { toastNotification, LOCAL_STORAGE } from "../utilities";
...
const BookingCancelledDetail = () => {
	...
	useEffect(() => {
		...
		const bookingSavedInfo = LOCAL_STORAGE.getItem("_b_savedInf");
		const basicInfo = LOCAL_STORAGE.getItem("_b_baseInf");
		setReBookingData({
			...bookingSavedInfo,
			...basicInfo,
		});
...
export default BookingCancelledDetail;
